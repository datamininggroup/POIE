...
class DataSuite extends FlatSpec with Matchers {
  ...
  it must "load arrays as PFAArray, not avro.generic.GenericData.Array" taggedAs(Data) in {
    ...
    arrayOfStrings.getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    arrayOfDoubles.getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    arrayOfarrayOfStrings.getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    arrayOfarrayOfStrings(0)(0) should be ("one")
    arrayOfarrayOfStrings(0).getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    arrayOfStringsInMap.get("hey").getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    // arrayOfStringsInRecord.get("hey").getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    // arrayOfStringsInRecord.get("hey").asInstanceOf[org.datamininggroup.poie.data.PFAArray[_]](0) should be ("one")
    ...
    arrayOfStringsInUnion.getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    arrayOfStrings2.getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    arrayOfDoubles2.getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    arrayOfStringsInMap2.get("hey").getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    // arrayOfStringsInRecord2.get("hey").getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
    ...
    arrayOfStringsInUnion2.getClass.getName should be ("org.datamininggroup.poie.data.PFAArray")
  }
  ...
  it must "load maps as PFAMap, not java.util.Map" taggedAs(Data) in {
    ...
    mapOfStrings.getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    mapOfDoubles.getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    mapOfmapOfStrings.getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    mapOfmapOfStrings("en")("a") should be ("one")
    mapOfmapOfStrings("en").getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    mapOfStringsInArray.get(0).getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    // mapOfStringsInRecord.get("hey").getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    // mapOfStringsInRecord.get("hey").asInstanceOf[org.datamininggroup.poie.data.PFAMap[_]]("a") should be ("one")
    ...
    mapOfStringsInUnion.getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    mapOfStrings2.getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    mapOfDoubles2.getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    mapOfStringsInArray2.get(0).getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    // mapOfStringsInRecord2.get("hey").getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
    ...
    mapOfStringsInUnion2.getClass.getName should be ("org.datamininggroup.poie.data.PFAMap")
  }
