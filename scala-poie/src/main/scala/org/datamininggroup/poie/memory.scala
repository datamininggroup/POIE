...
import org.datamininggroup.poie.data.GenericPFARecord
import org.datamininggroup.poie.data.PFARecord
import org.datamininggroup.poie.data.AnyPFAFixed
import org.datamininggroup.poie.data.AnyPFAEnumSymbol
...
package memory {
  ...
  case class Usage(bytes: Long, exact: Boolean = true) {
    /** Represent this memory as a `String`, using a given unit.
      * 
      * @param unit unit of measurement, such as [[org.datamininggroup.poie.memory.B B (bytes)]], [[org.datamininggroup.poie.memory.KB KB (kilobytes)]], [[org.datamininggroup.poie.memory.MB MB (megabytes)]], or [[org.datamininggroup.poie.memory.TB TB (terabytes)]]
