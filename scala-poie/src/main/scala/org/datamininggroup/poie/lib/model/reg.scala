...
package object reg {
  ...
  class LinearVariance(val pos: Option[String] = None) extends LibFcn with org.datamininggroup.poie.lib.la.EJMLInterface {
  ...
  class Mahalanobis(val pos: Option[String] = None) extends LibFcn with org.datamininggroup.poie.lib.la.EJMLInterface {
