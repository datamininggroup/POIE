...
import org.datamininggroup.poie.ast.SymbolTable
import org.datamininggroup.poie.ast.FunctionTable
import org.datamininggroup.poie.ast.AstContext
import org.datamininggroup.poie.ast.ExpressionContext
import org.datamininggroup.poie.ast.TaskResult
import org.datamininggroup.poie.ast.Task
import org.datamininggroup.poie.ast.LibFcn
import org.datamininggroup.poie.ast.UserFcn
import org.datamininggroup.poie.ast.Ast
import org.datamininggroup.poie.ast.Method
import org.datamininggroup.poie.ast.EngineConfig
import org.datamininggroup.poie.ast.CellSource
import org.datamininggroup.poie.ast.PoolSource
import org.datamininggroup.poie.ast.EmbeddedJsonDomCellSource
import org.datamininggroup.poie.ast.EmbeddedJsonDomPoolSource
import org.datamininggroup.poie.ast.Cell
import org.datamininggroup.poie.ast.Pool
import org.datamininggroup.poie.ast.Argument
import org.datamininggroup.poie.ast.Expression
import org.datamininggroup.poie.ast.LiteralValue
import org.datamininggroup.poie.ast.PathIndex
import org.datamininggroup.poie.ast.ArrayIndex
import org.datamininggroup.poie.ast.MapIndex
import org.datamininggroup.poie.ast.RecordIndex
import org.datamininggroup.poie.ast.FcnDef
import org.datamininggroup.poie.ast.FcnRef
import org.datamininggroup.poie.ast.FcnRefFill
import org.datamininggroup.poie.ast.CallUserFcn
import org.datamininggroup.poie.ast.Call
import org.datamininggroup.poie.ast.Ref
import org.datamininggroup.poie.ast.LiteralNull
import org.datamininggroup.poie.ast.LiteralBoolean
import org.datamininggroup.poie.ast.LiteralInt
import org.datamininggroup.poie.ast.LiteralLong
import org.datamininggroup.poie.ast.LiteralFloat
import org.datamininggroup.poie.ast.LiteralDouble
import org.datamininggroup.poie.ast.LiteralString
import org.datamininggroup.poie.ast.LiteralBase64
import org.datamininggroup.poie.ast.Literal
import org.datamininggroup.poie.ast.NewObject
import org.datamininggroup.poie.ast.NewArray
import org.datamininggroup.poie.ast.Do
import org.datamininggroup.poie.ast.Let
import org.datamininggroup.poie.ast.SetVar
import org.datamininggroup.poie.ast.AttrGet
import org.datamininggroup.poie.ast.AttrTo
import org.datamininggroup.poie.ast.CellGet
import org.datamininggroup.poie.ast.CellTo
import org.datamininggroup.poie.ast.PoolGet
import org.datamininggroup.poie.ast.PoolTo
import org.datamininggroup.poie.ast.PoolDel
import org.datamininggroup.poie.ast.If
import org.datamininggroup.poie.ast.Cond
import org.datamininggroup.poie.ast.While
import org.datamininggroup.poie.ast.DoUntil
import org.datamininggroup.poie.ast.For
import org.datamininggroup.poie.ast.Foreach
import org.datamininggroup.poie.ast.Forkeyval
import org.datamininggroup.poie.ast.CastCase
import org.datamininggroup.poie.ast.CastBlock
import org.datamininggroup.poie.ast.Upcast
import org.datamininggroup.poie.ast.IfNotNull
import org.datamininggroup.poie.ast.BinaryFormatter
import org.datamininggroup.poie.ast.Pack
import org.datamininggroup.poie.ast.Unpack
import org.datamininggroup.poie.ast.Doc
import org.datamininggroup.poie.ast.Error
import org.datamininggroup.poie.ast.Try
import org.datamininggroup.poie.ast.Log

import org.datamininggroup.poie.datatype.AvroConversions
import org.datamininggroup.poie.datatype.Type
import org.datamininggroup.poie.datatype.FcnType
import org.datamininggroup.poie.datatype.ExceptionType
import org.datamininggroup.poie.datatype.AvroType
import org.datamininggroup.poie.datatype.AvroCompiled
import org.datamininggroup.poie.datatype.AvroNumber
import org.datamininggroup.poie.datatype.AvroRaw
import org.datamininggroup.poie.datatype.AvroIdentifier
import org.datamininggroup.poie.datatype.AvroContainer
import org.datamininggroup.poie.datatype.AvroMapping
...
import org.datamininggroup.poie.datatype.ForwardDeclarationParser

import org.datamininggroup.poie.data.AnyPFARecord
import org.datamininggroup.poie.data.AvroDataTranslator
import org.datamininggroup.poie.data.AvroOutputDataStream
import org.datamininggroup.poie.data.JsonOutputDataStream
import org.datamininggroup.poie.data.CsvOutputDataStream
import org.datamininggroup.poie.data.OutputDataStream
import org.datamininggroup.poie.data.PFADataTranslator
import org.datamininggroup.poie.data.PFADatumReader
import org.datamininggroup.poie.data.PFADatumWriter
import org.datamininggroup.poie.data.PFAMap
import org.datamininggroup.poie.data.PFARecord
import org.datamininggroup.poie.data.PFASpecificData
import org.datamininggroup.poie.data.toJsonDom
import org.datamininggroup.poie.errors.PFAInitializationException
import org.datamininggroup.poie.errors.PFARuntimeException
import org.datamininggroup.poie.errors.PFASemanticException
import org.datamininggroup.poie.errors.PFATimeoutException
import org.datamininggroup.poie.errors.PFAUserException
import org.datamininggroup.poie.options.EngineOptions
import org.datamininggroup.poie.reader.jsonToAst
import org.datamininggroup.poie.shared.SharedMap
import org.datamininggroup.poie.shared.SharedMapInMemory
import org.datamininggroup.poie.shared.SharedState
...
import org.datamininggroup.poie.util.escapeJson
import org.datamininggroup.poie.yaml.yamlToJson

package object jvmcompiler {
  /** Version of the PFA language that this poie JAR attempts to use by default.
    */
  ...
  /** Express a [[org.datamininggroup.poie.datatype.AvroType AvroType]] as its corresponding Java type.
    * 
  ...
  def javaType(avroType: AvroType, boxed: Boolean, qualified: Boolean, generic: Boolean): String = avroType match {
    ...
    case x: AvroArray => "org.datamininggroup.poie.data.PFAArray<%s>".format(javaType(x.items, true, qualified, generic))
    case x: AvroMap => "org.datamininggroup.poie.data.PFAMap<%s>".format(javaType(x.values, true, qualified, generic))
    case _: AvroFixed if (generic) => "org.datamininggroup.poie.data.PFAFixed"
    case _: AvroEnum if (generic) => "org.datamininggroup.poie.data.PFAEnumSymbol"
    case _: AvroRecord if (generic) => "org.datamininggroup.poie.data.PFARecord"
  ...
  /** Express a [[org.datamininggroup.poie.datatype.AvroType AvroType]] as Java code that constructs the corresponding `org.apache.avro.Schema` inline.
    * 
...
package jvmcompiler {
  ...
  object W {
    ...
    /** Take a Scala `Either[Exception, X]` and throw the exception, if it contains an exception, or return the value if it contains a value.
      * 
      * If the exception is `java.lang.IndexOutOfBoundsException` or `java.util.NoSuchElementException`, use the given error strings and error codes to make an informative [[org.datamininggroup.poie.errors.PFARuntimeException PFARuntimeException]].
      * 
    ...
    /** Attempt to extract a value by key from a map (assuming it's a pool), raising a [[org.datamininggroup.poie.errors.PFARuntimeException PFARuntimeException]] (with appropriate error string and code) if it's not there.
      * 
      * @param map the map to extract from
      * @param get the key to extract
      * @param name the name of the pool (not used)
      * @param poolErrStr string to use for the [[org.datamininggroup.poie.errors.PFARuntimeException PFARuntimeException]]
      * @param poolErrCode code to use for the [[org.datamininggroup.poie.errors.PFARuntimeException PFARuntimeException]]
      * @param fcnName function name to use for the [[org.datamininggroup.poie.errors.PFARuntimeException PFARuntimeException]]
      * @param pos source file location from the locator mark
      */
    ...
    def wrapExpr(x: String, avroType: AvroType, boxed: Boolean): String = (avroType, boxed) match {
      case (_: AvroBoolean, false) => "org.datamininggroup.poie.jvmcompiler.W.asBool(" + x + ")"
      case (_: AvroInt, false) => "org.datamininggroup.poie.jvmcompiler.W.asInt(" + x + ")"
      case (_: AvroLong, false) => "org.datamininggroup.poie.jvmcompiler.W.asLong(" + x + ")"
      case (_: AvroFloat, false) => "org.datamininggroup.poie.jvmcompiler.W.asFloat(" + x + ")"
      case (_: AvroDouble, false) => "org.datamininggroup.poie.jvmcompiler.W.asDouble(" + x + ")"
      case (_: AvroBoolean, true) => "org.datamininggroup.poie.jvmcompiler.W.asJBool(" + x + ")"
      case (_: AvroInt, true) => "org.datamininggroup.poie.jvmcompiler.W.asJInt(" + x + ")"
      case (_: AvroLong, true) => "org.datamininggroup.poie.jvmcompiler.W.asJLong(" + x + ")"
      case (_: AvroFloat, true) => "org.datamininggroup.poie.jvmcompiler.W.asJFloat(" + x + ")"
      case (_: AvroDouble, true) => "org.datamininggroup.poie.jvmcompiler.W.asJDouble(" + x + ")"
      case (u: AvroUnion, _) =>
        if (u.types.exists(_.isInstanceOf[AvroDouble]))
          "org.datamininggroup.poie.jvmcompiler.W.maybeJDouble(" + x + ")"
        else if (u.types.exists(_.isInstanceOf[AvroFloat]))
          "org.datamininggroup.poie.jvmcompiler.W.maybeJFloat(" + x + ")"
        else if (u.types.exists(_.isInstanceOf[AvroLong]))
          "org.datamininggroup.poie.jvmcompiler.W.maybeJLong(" + x + ")"
        else if (u.types.exists(_.isInstanceOf[AvroInt]))
          "org.datamininggroup.poie.jvmcompiler.W.maybeJInt(" + x + ")"
        else
          x
    ...
    /** Try to evaluate function `f` and catch any PFA exceptions.
      ...
      * @param hasFilter if `true`, only catch exceptions referred to in `filters`; if `false`, catch any [[org.datamininggroup.poie.errors.PFARuntimeException PFARuntimeException]] or [[org.datamininggroup.poie.errors.PFAUserException PFAUserException]]
  ...
  /** Abstract class for interface [[org.datamininggroup.poie.jvmcompiler.PFAEngine PFAEngine]]; defines some functions in the poie JAR so they don't have to be defined in auto-generated Java.
    */
  abstract class PFAEngineBase {
    ...
    /** Check the clock and raise a [[org.datamininggroup.poie.errors.PFATimeoutException PFATimeoutException]] if a method has taken too long.
      * 
    ...
    var _instance: Int = -1
    /** The "metadata" field of the original PFA file as a [[org.datamininggroup.poie.data.PFAMap PFAMap]] that can be accessed within PFA.
      */
    ...
    /** Get the [[org.datamininggroup.poie.datatype.AvroType AvroType]] of each compiled type. */
    def namedTypes: Map[String, AvroType] = _namedTypes
    private var _namedTypes: Map[String, AvroType] = null
    /** Get the [[org.datamininggroup.poie.datatype.AvroType AvroType]] of the input. */
    def inputType: AvroType = _inputType
    private var _inputType: AvroType = null
    /** Get the [[org.datamininggroup.poie.datatype.AvroType AvroType]] of the output. */
    def outputType: AvroType = _outputType
    private var _outputType: AvroType = null
    /** Report whether this is a [[org.datamininggroup.poie.jvmcompiler.PFAMapEngine PFAMapEngine]], [[org.datamininggroup.poie.jvmcompiler.PFAEmitEngine PFAEmitEngine]], or a [[org.datamininggroup.poie.jvmcompiler.PFAFoldEngine PFAFoldEngine]] */
    ...
    private def cellState(cell: String, shared: Boolean): Any =
      if (shared)
        publicCells.get(cell, Array[org.datamininggroup.poie.shared.PathIndex]()) match {
          case Left(err) => throw err
          case Right(x) => x
        }
      else
  ...
  /** Interface for a poie scoring engine.
    * 
    * Create instances using one of [[org.datamininggroup.poie.jvmcompiler.PFAEngine$ `PFAEngine`'s "static" methods]], then call `begin` once, `action` once for each datum in the data stream, and `end` once (if the stream ever ends). The rest of the functions are for
    ...
    *  - handling log output or emit output (see [[org.datamininggroup.poie.jvmcompiler.PFAEmitEngine PFAEmitEngine]]) with callbacks,
    ...
    * 
    * {{{
    * import org.datamininggroup.poie.jvmcompiler.PFAEngine
    ...
    * 
    * {{{
    * import org.datamininggroup.poie.jvmcompiler.PFAEmitEngine
    * engine match {
    ...
    * 
    * {{{
    * import org.datamininggroup.poie.data.toJson
    ...
    * import org.datamininggroup.poie.datatype._
    ...
    *  - '''string:''' `String` 
    *  - '''bytes:''' `Array[Byte]`
    *  - '''array(X):''' [[org.datamininggroup.poie.data.PFAArray PFAArray[X]]] where `X` is an unboxed primitive if a primitive
    *  - '''map(X):''' [[org.datamininggroup.poie.data.PFAMap PFAMap[X]]] where `X` is a boxed primitive if a primitive
    *  - '''enum:''' subclass of [[org.datamininggroup.poie.data.PFAEnumSymbol PFAEnumSymbol]] that can only be found in this specific `PFAEngine`'s custom ClassLoader (cannot be created by external agent)
    *  - '''fixed:''' subclass of [[org.datamininggroup.poie.data.PFAFixed PFAFixed]] that can only be found in the custom ClassLoader
    *  - '''record:''' subclass of [[org.datamininggroup.poie.data.PFARecord PFARecord]] that can only be found in the custom ClassLoader
  ...
  /** Companion object for poie scoring engines: defines "static" methods. */
  object PFAEngine {
    /** Create a factory (0-parameter function) to make instances of this scoring engine from a PFA abstract syntax tree ([[org.datamininggroup.poie.ast.EngineConfig EngineConfig]]).
      * 
      ...
      * 
      * @param engineConfig a parsed, interpreted PFA document, i.e. produced by [[org.datamininggroup.poie.reader.jsonToAst jsonToAst]]
    ...
    /** Create a collection of instances of this scoring engine from a PFA abstract syntax tree ([[org.datamininggroup.poie.ast.EngineConfig EngineConfig]]).
      * 
  ...
  /** Interface for a `method` = map poie scoring engine (one that returns one output for each input).
    * 
    * See [[org.datamininggroup.poie.jvmcompiler.PFAEngine PFAEngine]] for details.
    */
  trait PFAMapEngine[INPUT <: AnyRef, OUTPUT <: AnyRef] extends PFAEngine[INPUT, OUTPUT]

  /** Interface for a `method` = emit poie scoring engine (one that returns zero or more outputs for each input).
    * 
    * This kind of engine differs from a [[org.datamininggroup.poie.jvmcompiler.PFAEngine PFAEngine]] in that it has an externally supplied `emit` callback to collect results, and `action` always returns `null`.
    * 
    * See [[org.datamininggroup.poie.jvmcompiler.PFAEngine PFAEngine]] for details.
    */
  ...
  /** Interface for a `method` = fold poie scoring engine (one that accumulates a tally).
    * 
    * This kind of engine differs from a [[org.datamininggroup.poie.jvmcompiler.PFAEngine PFAEngine]] in that it has an externally modifiable `tally` field with the running sum or current accumulation of the scoring engine and a `merge` method to combine tallies from scoring engines running in parallel.
    * 
    * See [[org.datamininggroup.poie.jvmcompiler.PFAEngine PFAEngine]] for details.
    */
  ...
  /** TaskResult for [[org.datamininggroup.poie.jvmcompiler.JVMCompiler JVMCompiler]], which represents Java code.
    * 
  ...
  /** Most common [[org.datamininggroup.poie.ast.Task Task]] for [[org.datamininggroup.poie.ast.Ast Ast]] `walk`; generates Java code from a PFA AST.
    */
  class JVMCompiler extends Task {
    ...
    def block(exprs: Seq[TaskResult], returnMethod: ReturnMethod.ReturnMethod, retType: AvroType): String = returnMethod match {
      case ReturnMethod.NONE =>
        (exprs map {"org.datamininggroup.poie.jvmcompiler.W.s(" + _.toString + ");"}).mkString("\n")
      case ReturnMethod.RETURN =>
        ((exprs.init map {"org.datamininggroup.poie.jvmcompiler.W.s(" + _.toString + ");"}) ++ List("return %s;".format(retType match {
    ...
    def makePathIndex(path: Seq[PathIndex]): String = path.map(_ match {
      case ArrayIndex(expr, t) => """new org.datamininggroup.poie.shared.I(org.datamininggroup.poie.jvmcompiler.W.asInt(%s))""".format(expr.toString)
      case MapIndex(expr, t) => """new org.datamininggroup.poie.shared.M(%s)""".format(expr.toString)
      case RecordIndex(name, t) => """new org.datamininggroup.poie.shared.R("%s")""".format(StringEscapeUtils.escapeJava(name))
    }).mkString(", ")
...
public class %s extends org.datamininggroup.poie.data.PFARecord%s {
...
%s
    ...
    public org.datamininggroup.poie.data.PFARecord internalUpdate(int i, Object elem) {
%s out = new %s();
%s
out.put(i, elem);
return out;
    ...
    public org.datamininggroup.poie.data.PFARecord internalUpdate(String i, Object elem) {
%s out = new %s();
%s
out.put(i, elem);
return out;
    ...
    public org.datamininggroup.poie.data.PFARecord multiUpdate(String[] fields, Object[] values) {
%s out = new %s();
%s
...
""",          namespace map {"package " + _ + ";"} mkString(""),
          ...
          case AvroFixed(size, name, namespace, _, _) => {
            dependencyBuilder += (t(namespace, name, true) -> JavaCode("""%s
public class %s extends org.datamininggroup.poie.data.PFAFixed {
    public static final org.apache.avro.Schema SCHEMA$ = %s;
    public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
    ...
    public %s(org.datamininggroup.poie.data.AnyPFAFixed that) {
        super();
        bytes(that.bytes());
    }

    public org.datamininggroup.poie.data.PFAFixed overlay(byte[] replacement) {
...
""",          namespace map {"package " + _ + ";"} mkString(""),
          ...
          case AvroEnum(symbols, name, namespace, _, _) => {
            dependencyBuilder += (t(namespace, name, true) -> JavaCode("""%s
public class %s extends org.datamininggroup.poie.data.PFAEnumSymbol implements org.apache.avro.generic.GenericEnumSymbol, Comparable<org.apache.avro.generic.GenericEnumSymbol> {
    public static final org.apache.avro.Schema SCHEMA$ = %s;
    public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
    public org.apache.avro.Schema getSchema() { return SCHEMA$; }
    ...
    public %s(org.datamininggroup.poie.data.AnyPFAEnumSymbol that) {
...
%s
        ...
        val (interface, actionMethod) = method match {
          case Method.MAP =>
            ("org.datamininggroup.poie.jvmcompiler.PFAMapEngine<%s, %s>".format(javaType(input, true, true, true), javaType(output, true, true, true)),
              """%s
...
return out;
          ...
          case Method.EMIT =>
            ("org.datamininggroup.poie.jvmcompiler.PFAEmitEngine<%s, %s>".format(javaType(input, true, true, true), javaType(output, true, true, true)),
...
return %s;
            ...
            ("org.datamininggroup.poie.jvmcompiler.PFAFoldEngine<%s, %s>".format(javaType(input, true, true, true), javaType(output, true, true, true)),
              """    private %s %s;
    public %s tally() { return %s; }
    public void tally_$eq(%s newTally) { %s = newTally; }
%s
    public void initialize(org.datamininggroup.poie.ast.EngineConfig config, org.datamininggroup.poie.options.EngineOptions options, scala.Option<org.datamininggroup.poie.shared.SharedState> state, Class<%s> thisClass, org.datamininggroup.poie.ast.EngineConfig.Context context, int index) {
        super.initialize(config, options, state, thisClass, context, index);
        try {
            %s = (%s)fromJson("%s".getBytes(), %s);
        }
        catch (Exception err) {
            throw new org.datamininggroup.poie.errors.PFAInitializationException("zero does not conform to output type " + %s.toString());
        }
    }
%s
...
%s
        ...
        val sharedPools = 
          for ((pname, pool) <- pools if (pool.shared)) yield
            """public org.datamininggroup.poie.shared.SharedMap %s;""".format(p(pname))
...
%s
        ...
        JavaCode("""public class %s extends org.datamininggroup.poie.jvmcompiler.PFAEngineBase implements %s {
final org.datamininggroup.poie.jvmcompiler.PFAEngineBase thisEngineBase = this;
final %s thisInterface = this;
private Object runlock = new Object();
public Object getRunlock() { return runlock; }
%s
public org.datamininggroup.poie.shared.SharedMap sharedCells;
%s
%s
%s
java.util.HashMap<String, Object> literals = new java.util.HashMap<String, Object>();
public %s(org.datamininggroup.poie.ast.EngineConfig config, org.datamininggroup.poie.options.EngineOptions options, scala.Option<org.datamininggroup.poie.shared.SharedState> state, org.datamininggroup.poie.ast.EngineConfig.Context context, Integer index) {
    _inputClass_$eq(%s);
    _outputClass_$eq(%s);
%s
...
public void checkClock() {
    if (timeout > 0  &&  System.currentTimeMillis() - startTime > timeout) {
        throw new org.datamininggroup.poie.errors.PFATimeoutException(String.format("exceeded timeout of %%d milliseconds", timeout));
    }
}
%s
%s
...
return (%s)out;
          ...
          case avroMap: AvroMap =>
            JavaCode("""(new Object() {
public %s apply() {
%s out = org.datamininggroup.poie.data.PFAMap.empty(%s, %s);
%s
return out;
} }).apply()""",
              javaType(retType, false, true, false),
      ...
      case NewArray.Context(retType, calls, items) =>
        JavaCode("""(new Object() {
public %s apply() {
%s out = org.datamininggroup.poie.data.PFAArray.empty(%s, %s);
%s
return out;
} }).apply()""",
          javaType(retType, false, true, false),
...
%s
      ...
      case Let.Context(_, _, nameTypeExpr) => {
        def wrap(nameTypeExpr: List[(String, AvroType, JavaCode)]): JavaCode = nameTypeExpr match {
          case (name, t, expr) :: Nil => JavaCode("org.datamininggroup.poie.jvmcompiler.W.n(%s = (%s)(%s))", s(name), javaType(t, false, true, false), W.wrapExpr(expr.toString, t, false))
          case (name, t, expr) :: rest => JavaCode("org.datamininggroup.poie.jvmcompiler.W.nn(%s = (%s)(%s), %s)", s(name), javaType(t, false, true, false), W.wrapExpr(expr.toString, t, false), wrap(rest).toString)
        }
      ...
      case AttrGet.Context(retType, _, expr, exprType, path, pos) => {
        ...
        for (item <- path) item match {
          case ArrayIndex(expr, t) => out = """((%s)(%s.get(org.datamininggroup.poie.jvmcompiler.W.asInt(%s))))""".format(javaType(t, true, true, false), out, expr.toString)
...
try {
    ...
    throw new org.datamininggroup.poie.errors.PFARuntimeException("array index not found", 2000, "attr", %s, err);
}
catch (java.util.NoSuchElementException err) {
    throw new org.datamininggroup.poie.errors.PFARuntimeException("map key not found", 2001, "attr", %s, err);
}
...
public %s apply() {
try {
    return (%s)%s.updated(new org.datamininggroup.poie.shared.PathIndex[]{%s}, %s, %s);
}
catch (java.lang.IndexOutOfBoundsException err) {
    throw new org.datamininggroup.poie.errors.PFARuntimeException("array index not found", 2002, "attr-to", %s, err);
}
catch (java.util.NoSuchElementException err) {
    throw new org.datamininggroup.poie.errors.PFARuntimeException("map key not found", 2003, "attr-to", %s, err);
}
} }).apply()""",
...
try {
    ...
    throw new org.datamininggroup.poie.errors.PFARuntimeException("array index not found", 2004, "cell", %s, err);
}
catch (java.util.NoSuchElementException err) {
    throw new org.datamininggroup.poie.errors.PFARuntimeException("map key not found", 2005, "cell", %s, err);
}
} }).apply()""".format(javaType(retType, false, true, false), out, posToJava(pos), posToJava(pos)))
        }
        else {
          JavaCode("""((%s)org.datamininggroup.poie.jvmcompiler.W.either(sharedCells.get("%s", new org.datamininggroup.poie.shared.PathIndex[]{%s}), "array index not found", 2004, "map key not found", 2005, "cell", %s))""",
      ...
      case CellTo.Context(retType, _, cell, cellType, setType, path, to, toType, shared, pos) => {
        ...
        if (!shared) {
          if (path.isEmpty)
            ...
            JavaCode("""(%s = (%s)%s.updated(new org.datamininggroup.poie.shared.PathIndex[]{%s}, %s, %s, "array index not found", 2006, "map key not found", 2007, "cell-to", %s))""",
              c(cell),
          ...
          JavaCode("""((%s)org.datamininggroup.poie.jvmcompiler.W.either(sharedCells.update("%s", new org.datamininggroup.poie.shared.PathIndex[]{%s}, null, %s, %s), "array index not found", 2006, "map key not found", 2007, "cell-to", %s))""",
            javaType(retType, true, true, false),
            cell,
            makePathIndex(path),
            toFcn,
      ...
      case PoolGet.Context(retType, _, pool, path, shared, pos) => {
        if (!shared) {
          var out = """((%s)(org.datamininggroup.poie.jvmcompiler.W.getOrFailPool(%s, %s, "%s", "map key not found", 2009, "pool", %s)))""".format(
...
try {
    ...
    throw new org.datamininggroup.poie.errors.PFARuntimeException("array index not found", 2008, "pool", %s, err);
}
catch (java.util.NoSuchElementException err) {
    throw new org.datamininggroup.poie.errors.PFARuntimeException("map key not found", 2009, "pool", %s, err);
}
} }).apply()""".format(javaType(retType, false, true, false), out, posToJava(pos), posToJava(pos)))
        }
        else {
          JavaCode("""((%s)org.datamininggroup.poie.jvmcompiler.W.either(%s.get(%s, new org.datamininggroup.poie.shared.PathIndex[]{%s}), "array index not found", 2008, "map key not found", 2009, "pool", %s))""",
            javaType(retType, true, true, false),
            p(pool),
            path.head.asInstanceOf[MapIndex].k.toString,
      ...
      case PoolTo.Context(retType, _, pool, poolType, setType, path, to, toType, init, shared, pos) => {
        ...
        if (!shared) {
          if (path.size == 1)
            JavaCode("""org.datamininggroup.poie.jvmcompiler.W.do2(%s.put(%s, %s.apply(org.datamininggroup.poie.jvmcompiler.W.getOrElse(%s, %s, %s))), %s.get(%s))""",
              p(pool),
              path.head.asInstanceOf[MapIndex].k.toString,
              toFcn,
              p(pool),
            ...
            JavaCode("""org.datamininggroup.poie.jvmcompiler.W.do2(%s.put(%s, ((%s)(org.datamininggroup.poie.jvmcompiler.W.getOrElse(%s, %s, %s))).updated(new org.datamininggroup.poie.shared.PathIndex[]{%s}, %s, %s, "array index not found", 2010, "map key not found", 2011, "pool-to", %s)), %s.get(%s))""",
              p(pool),
              path.head.asInstanceOf[MapIndex].k.toString,
              javaType(path.head.asInstanceOf[MapIndex].t, true, true, false),
              p(pool),
          ...
          JavaCode("""((%s)org.datamininggroup.poie.jvmcompiler.W.either(%s.update(%s, new org.datamininggroup.poie.shared.PathIndex[]{%s}, %s, %s, %s), "array index not found", 2010, "map key not found", 2011, "pool-to", %s))""",
            javaType(retType, true, true, false),
            p(pool),
            path.head.asInstanceOf[MapIndex].k.toString,
            makePathIndex(path.tail),
      ...
      case PoolDel.Context(retType, _, pool, del, shared) =>
        JavaCode("""org.datamininggroup.poie.jvmcompiler.W.n(%s.remove(%s))""", p(pool), del.toString)
      ...
      case If.Context(retType, _, thenSymbols, predicate, thenClause, elseSymbols, elseClause) => (elseSymbols, elseClause) match {
        case (Some(symbols), Some(clause)) =>
          JavaCode("""(new Object() {
public %s apply() {
if (org.datamininggroup.poie.jvmcompiler.W.asBool(%s)) {
return (new Object() {
%s
public %s apply() {
%s
...
""".format(walkBlock.pred match {
             case Some(p) if (first) => first = false; "if (org.datamininggroup.poie.jvmcompiler.W.asBool(%s))".format(p)
             case Some(p) => "else if (org.datamininggroup.poie.jvmcompiler.W.asBool(%s))".format(p)
             case None => "else"
           },
      ...
      case Pack.Context(retType, calls, exprsDeclareRes, pos) => {
        ...
        val evaluateAndCountBytes = exprsDeclareRes flatMap {_ match {
          ...
          case BinaryFormatter.DeclareRawSize(value: JavaCode, size) =>
            ...
            List("byte[] tmp" + counter.toString + " = " + value.toString + ";",
                 "numBytes += tmp" + counter.toString + ".length;",
                 "if (tmp" + counter.toString + ".length != " + size.toString + ") throw new org.datamininggroup.poie.errors.PFARuntimeException(\"raw bytes does not have specified size\", 3000, \"pack\", " + posToJava(pos) + ", null);")
          ...
          case BinaryFormatter.DeclarePrefixed(value: JavaCode) =>
            ...
            List("byte[] tmp" + counter.toString + " = " + value.toString + ";",
                 "numBytes += tmp" + counter.toString + ".length + 1;",
                 "if (tmp" + counter.toString + ".length > 255) throw new org.datamininggroup.poie.errors.PFARuntimeException(\"length prefixed bytes is larger than 255 bytes\", 3001, \"pack\", " + posToJava(pos) + ", null);")
        }} mkString("\n")
...
public Object apply() {
    if (dummy)
        throw new org.datamininggroup.poie.errors.PFAUserException("%s", %s, %s);
    return null;
}
}).apply()""",
      ...
      case Try.Context(retType, _, symbols, exprs, exprType, filter) =>
        JavaCode("""org.datamininggroup.poie.jvmcompiler.W.trycatch(new scala.runtime.AbstractFunction0<%s>() {
%s
public %s apply() {
%s
} }, %s, new String[]{%s})""",
