...
import org.datamininggroup.poie.ast.validSymbolName
import org.datamininggroup.poie.ast.validFunctionName
...
import org.datamininggroup.poie.ast.CellPoolSource
...
import org.datamininggroup.poie.ast.ExternalJsonCellSource
import org.datamininggroup.poie.ast.ExternalJsonPoolSource
import org.datamininggroup.poie.ast.ExternalAvroCellSource
import org.datamininggroup.poie.ast.ExternalAvroPoolSource
...
import org.datamininggroup.poie.datatype.AvroTypeBuilder

import org.datamininggroup.poie.errors.PFASyntaxException
import org.datamininggroup.poie.util.escapeJson
import org.datamininggroup.poie.util.pos
import org.datamininggroup.poie.util.uniqueEngineName
...
package reader {
  ...
  object jsonToAst extends Function1[String, EngineConfig] {
    ...
    private[poie] def ingestJsonAndIgnore(parser: JsonParser, token: JsonToken, dot: String): Unit = token match {
