...
import poie.version
from poie.inspector.defs import *
...
class InspectorMode(Mode):
    ...
    def __init__(self, initialCommands, gadgets):
        ...
        :type gadgets: list of poie.inspector.defs.Gadget
        ...
        print("""poie PFA Inspector (version {0})
Type 'help' for a list of commands.""".format(poie.version.__version__))
