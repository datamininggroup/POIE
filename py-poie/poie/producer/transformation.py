...
from poie.prettypfa import ppfa
from poie.prettypfa import pfa
...
class Transformation(object):
    ...
    def interpret(x):
        ...
        :type x: poie.datatype.Ast, PrettyPFA string
        :param x: input PFA
        :rtype: Pythonized JSON
    ...
    def new(self, avroType, subs={}, **subs2):
        ...
        :param subs: subsipypoieions to apply
        :type subs2: dict of substitutions
        :param subs2: more subsipypoieions to apply
        :rtype: Pythonized JSON
