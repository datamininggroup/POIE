...
from poie.util import callfcn, negativeIndex, startEnd
...
class Median(LibFcn):
    ...
    def __call__(self, state, scope, pos, paramTypes, a):
        ...
        half = len(sa) // 2  # py27 uses `/` as integer division
...
def cmp_to_key(mycmp):
    """
    Convert a cmp= function into a key= function per docs suggestion
