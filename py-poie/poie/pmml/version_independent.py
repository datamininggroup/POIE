...
from poie.util import uniqueEngineName, uniqueRecordName, uniqueEnumName
...
class Context(object):
    ...
    def fieldRef(self, name):
        ...
        :rtype: pypoie.pfaast.Ref or pypoie.pfaast.AttrGet
...
class ModelElement(object):
    ...
    def defineFields(self, options, context, transformations):
        ...
        :type context: pypoie.pmml.version_independent.Context
