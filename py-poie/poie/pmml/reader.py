...
import poie.pmml.version_independent
import poie.pmml.version_3_2
import poie.pmml.version_4_0
import poie.pmml.version_4_1
import poie.pmml.version_4_2
...
class PmmlContentHandler(xml.sax.handler.ContentHandler):
    ...
    def setVersion(self, version):
        ...
        if version == "3.2":
            self.namespace = poie.pmml.version_3_2.namespace
            self.tagToClass = poie.pmml.version_3_2.tagToClass
        elif version == "4.0" or version == "4.0.1":
            self.namespace = poie.pmml.version_4_0.namespace
            self.tagToClass = poie.pmml.version_4_0.tagToClass
        elif version == "4.1":
            self.namespace = poie.pmml.version_4_1.namespace
            self.tagToClass = poie.pmml.version_4_1.tagToClass
        elif version == "4.2":
            self.namespace = poie.pmml.version_4_2.namespace
            self.tagToClass = poie.pmml.version_4_2.tagToClass
        else:
...
def loadPMML(pmmlInput, processNamespaces=False):
    ...
    :rtype: pypoie.pmml.version_independent.PmmlBinding
    :return: loaded PMML
    """
...
def pmmlToAst(pmmlInput, options=None):
    ...
    context = poie.pmml.version_independent.Context()
