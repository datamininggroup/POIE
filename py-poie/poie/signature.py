...
class PFAVersion(object):
    ...
    def fromString(x):
        ...
        :rtype: pypoie.signature.PFAVersion
...
class Lifespan(object):
    ...
    def __init__(self, birth, deprecation, death, contingency):
        ...
        """
        """ TDH Commenting out code TDO - fixz logic to avoid comapring objects"""
    ...
    def current(self, now):
        """:type now: pypoie.signature.PFAVersion
        ...
        """
        return True #TDH (self.birth is None or now >= self.birth) and (self.deprecation is None or now < self.deprecation)
...
class LabelData(object):
    ...
    def broadestType(candidates):
        ...
        :type candidates: list of poie.datatype.AvroType
    ...
    def __repr__(self):
        return "<poie.signature.LabelData {0} at {1}>".format(self.members, "0x%x" % id(self))

class Signature(object):
    """Abstract trait for function signatures. Known subclasses: poie.signature.Sig and poie.signature.Sigs."""
...
class Sigs(Signature):
    ...
    def __init__(self, cases):
        """:type cases: list of poie.signature.Sig
    ...
    def accepts(self, args, version):
        ...
        :type args: list of poie.datatype.AvroType
        ...
        :rtype: (pypoie.signature.Sig, list of poie.datatype.AvroType, AvroType)
...
class Sig(Signature):
    ...
    This class can either be used directly as a function's only signature or it may be contained within a poie.signature.Sigs.
    """
    ...
    def __init__(self, params, ret, lifespan = Lifespan(None, None, None, None)):
        ...
        :type lifespan: pypoie.signature.Lifespan
    ...
    def check(self, pat, arg, labelData, strict, reversed):
        ...
        :type arg: pypoie.datatype.AvroType
        :param arg: supplied argument type that may or may not fit the pattern
        :type labelData: dict from label letters to poie.signature.LabelData
    ...
    def assign(self, pat, arg, assignments):
        ...
        :type assignments: dict from label letters to poie.datatype.AvroType
...
def toTextType(x):
    ...
    :type x: pypoie.datatype.AvroType
