...
class TestPrettyPfaParsing(unittest.TestCase):
    def testStructure(self):
        self.assertEqual(poie.prettypfa.jsonNode(r'''
name: Test
method: fold
input: double
output: double
...
''', lineNumbers=False, check=False), {"name": "Test", "input": "double", "output": "double", "method": "fold", "begin": [{"+": [2, 2]}], "action": [{"+": ["input", "tally"]}], "end": [{"+": [3, 3]}, {"+": [4, 4]}], "zero": [1, 2, 3], "merge": [{"+": ["tallyOne", "tallyTwo"]}], "randseed": 12345, "doc": "hello world", "version": 12, "metadata": {"this": "good"}, "options": {"wow": "wee"}})
    ...
    def testCells(self):
        def test(expr, asjson):
            self.assertEqual(json.loads(poie.prettypfa.json(r'''
input: double
output: double
action: null
cells: HERE
...
''', lineNumbers=False, check=False), {"name": "Test",
    ...
    def testLiteralNumbers(self):
        def test(expr, cls):
            self.assertTrue(isinstance(poie.prettypfa.ast(r'''
name: Test
input: double
output: double
action: HERE
'''.replace("HERE", expr), check=False).action[0], cls))
        ...
        test("null", poie.pfaast.LiteralNull)
        test("true", poie.pfaast.LiteralBoolean)
        test("false", poie.pfaast.LiteralBoolean)
        test("2", poie.pfaast.LiteralInt)
        test("-2", poie.pfaast.LiteralInt)
        test("2.", poie.pfaast.LiteralDouble)
        test("2.0", poie.pfaast.LiteralDouble)
        test("2e5", poie.pfaast.LiteralDouble)
        test("2.e5", poie.pfaast.LiteralDouble)
        test("2.0e5", poie.pfaast.LiteralDouble)
        test("2E5", poie.pfaast.LiteralDouble)
        test("2.E5", poie.pfaast.LiteralDouble)
        test("2.0E5", poie.pfaast.LiteralDouble)
        test("-2.", poie.pfaast.LiteralDouble)
...
'''.replace("HERE", expr)
            ...
            self.assertTrue(isinstance(poie.prettypfa.ast(text, check=False).action[0], cls))
            self.assertEqual(json.loads(poie.prettypfa.json(text, lineNumbers=False, check=False))["action"][0], asnode)

        test("json(null, null)", poie.pfaast.LiteralNull, None)
        test("json(int, 13)", poie.pfaast.LiteralInt, 13)
        test("json(long, 13)", poie.pfaast.LiteralLong, {"long": 13})
        test("json(float, 13.2)", poie.pfaast.LiteralFloat, {"float": 13.2})
        test("json(double, 13.2)", poie.pfaast.LiteralDouble, 13.2)
        test(r"json(string, hello)", poie.pfaast.LiteralString, {"string": "hello"})
        test(r'''json(string, "he\"llo")''', poie.pfaast.LiteralString, {"string": "he\"llo"})
        test("json(string, 'hel\"lo\')", poie.pfaast.LiteralString, {'string': 'hel"lo'})
        test('json(bytes, "aGVsbG8=")', poie.pfaast.LiteralBase64, {"base64": "aGVsbG8="})
        test("json(array(double), [])", poie.pfaast.Literal, {"type": {"type": "array", "items": "double"}, "value": []})
        test("json(array(double), [1, 2, 3])", poie.pfaast.Literal, {"type": {"type": "array", "items": "double"}, "value": [1, 2, 3]})
        test("json(array(array(double)), [[1, 2, 3], [4, 5, 6], [7, 8, 9]])", poie.pfaast.Literal, {"type": {"type": "array", "items": {"type": "array", "items": "double"}}, "value": [[1, 2, 3], [4, 5, 6], [7, 8, 9]]})
        test(r"json(map(double), {})", poie.pfaast.Literal, {"type": {"type": "map", "values": "double"}, "value": {}})
        test(r"json(map(double), {on.e: 1, two: 2, three: 3})", poie.pfaast.Literal, {"type": {"type": "map", "values": "double"}, "value": {"on.e": 1, "two": 2, "three": 3}})
        test(r"json(map(double), {'on.e': 1, 'two': 2, 'three': 3})", poie.pfaast.Literal, {"type": {"type": "map", "values": "double"}, "value": {"on.e": 1, "two": 2, "three": 3}})
        test(r'json(map(double), {"on.e": 1, "two": 2, "three": 3})', poie.pfaast.Literal, {"type": {"type": "map", "values": "double"}, "value": {"on.e": 1, "two": 2, "three": 3}})
        test(r'json(array(map(double)), [{"on.e": 1, "two": 2, "three": 3}, {}])', poie.pfaast.Literal, {"type": {"type": "array", "items": {"type": "map", "values": "double"}}, "value": [{"on.e": 1, "two": 2, "three": 3}, {}]})
        test(r'json(record(one: int, two: double, three: string, TestRecord), {one: 1, two: 2.2, three: "THREE"})', poie.pfaast.Literal, {"type": {"type": "record", "name": "TestRecord", "fields": [{"name": "one", "type": "int"}, {"name": "two", "type": "double"}, {"name": "three", "type": "string"}]}, "value": {"one": 1, "two": 2.2, "three": "THREE"}})
        test("int(13)", poie.pfaast.LiteralInt, 13)
        test("long(13)", poie.pfaast.LiteralLong, {"long": 13})
        test("float(13.2)", poie.pfaast.LiteralFloat, {"float": 13.2})
        test("double(13.2)", poie.pfaast.LiteralDouble, 13.2)
        test("string(hey)", poie.pfaast.LiteralString, {"string": "hey"})
        test('string("hey")', poie.pfaast.LiteralString, {"string": "hey"})
        test("string('hey')", poie.pfaast.LiteralString, {"string": "hey"})
        test('bytes("aGVsbG8=")', poie.pfaast.LiteralBase64, {"base64": "aGVsbG8="})
        test("Numero@uno", poie.pfaast.Literal, {"type": "Numero", "value": "uno"})
        test("super.duper.Numero@uno", poie.pfaast.Literal, {"type": "super.duper.Numero", "value": "uno"})
...
'''.replace("HERE", expr)
        ...
        test("new(array(int), 1, 2, 3)", poie.pfaast.NewArray, {"type": {"type": "array", "items": "int"}, "new": [1, 2, 3]})
        test("new(map(int), one: 1, two: 2, three: 3)", poie.pfaast.NewObject, {"type": {"type": "map", "values": "int"}, "new": {"one": 1, "two": 2, "three": 3}})
...
''', lineNumbers=False, check=False)["action"][0]["f"][0], {"fcn": "somefunc", "fill": {"this": "that", "other": {"+": [2, 2]}}})
        ...
        self.assertEqual(poie.prettypfa.jsonNode('''
input: double
output: double
action: f(m.sqrt)
...
''', lineNumbers=False, check=False)["action"][0], {"log": [1, 2, 3], "namespace": "wowie"})
    ...
    def testControl(self):
        def test(expr, asjson):
            converted = json.loads(poie.prettypfa.json(r'''
input: double
output: double
action: HERE
...
'''.replace("HERE", expr), lineNumbers=False, check=False))["action"]
    ...
    def testWhitespace(self):
        ...
        for x in xrange(100):
            ...
            try:
                tested = poie.prettypfa.jsonNode(test, lineNumbers=False, check=False)
...
''', lineNumbers=False), {"name": "test", "input": {"items": "int", "type": "array"}, "output": {"items": "int", "type": "array"}, "method": "map", "action": [{"a.concat": ["input", {"type": {"items": "int", "type": "array"}, "new": [1, 2, 3]}]}]})
        ...
        checkme = poie.prettypfa.jsonNode(r'''
name: test
input: some
output: some
