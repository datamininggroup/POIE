...
class Parser(object):
    ...
    def parse(self, text, subs):
        ...
        :rtype: poie.pfaast.EngineConfig or poie.pfaast.Expression
...
def subs(originalAst, **subs2):
    ...
    :type originalAst: poie.pfaast.Ast
...
def ast(text, check=True, version=None, subs={}, **subs2):
    ...
    :rtype: poie.pfaast.EngineConfig
