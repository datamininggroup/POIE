...
class PFAVersion(object):
    ...
    def fromString(x):
        ...
        :rtype: poie.signature.PFAVersion
...
class Lifespan(object):
    ...
    def current(self, now):
        """:type now: poie.signature.PFAVersion
...
class Sigs(Signature):
    ...
    def accepts(self, args, version):
        ...
        :rtype: (poie.signature.Sig, list of poie.datatype.AvroType, AvroType)
...
class Sig(Signature):
    ...
    def __init__(self, params, ret, lifespan = Lifespan(None, None, None, None)):
        ...
        :type lifespan: poie.signature.Lifespan
    ...
    def check(self, pat, arg, labelData, strict, reversed):
        ...
        :type arg: poie.datatype.AvroType
